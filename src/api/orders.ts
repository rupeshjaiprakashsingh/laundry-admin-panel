...
export const updatePaymentStatus = (id: number, paymentStatus: string, paymentMode?: string) =>
  api.put(`/orders/${id}/payment-status`, { paymentStatus, paymentMode }).then((r) => r.data);
